          ...
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <CardDescription>
                  When enabled, the AI agent will automatically reply to comments on your Instagram posts using your training data and FAQs.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  Automatically respond to Instagram post comments with AI-generated replies
                </p>
              </div>
              <Switch
            ...
            {commentAutoReplyEnabled && (
              <>
                ...
                <div className="space-y-3">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    Wait this many seconds before replying to avoid looking automated (0–30 seconds).
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Skip comments from your own Instagram account
                    </p>
                  </div>
                  <Switch
          ...
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <CardDescription>
                  Automatically send a private message (DM) to users who comment on your posts. The AI will generate a personalized message based on their comment.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  Send a private DM to commenters after replying to their comment
                </p>
              </div>
              <Switch
